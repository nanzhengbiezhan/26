...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void init(SQLiteDatabase db){
        String sql[] = {
                ...
                "insert into student values (10004,'小朱','男',20,'123456789')",
                "insert into student values (10005,'小孙','女',20,'123456789')",
                "insert into student values (10006,'小蔡','男',20,'123456789')",
                "insert into student values (00000,'管理员','男',0,'0000000')",
                "insert into course values (10001,'高数',6)",
                "insert into course values (10002,'思修',5)",
                "insert into course values (10003,'专业英语',5)",
                "insert into course values (10004,'大学物理',3)",
                "insert into course values (10005,'体育',3)",
                "insert into course values (10006,'数据库',8)",
                "insert into course values (10007,'数据结构',6)",
                "insert into course values (10008,'组成原理',4)",
                "insert into course values (10009,'操作系统',6)",
                "insert into course values (10010,'计算机网络',5)",
